/*
 *ex09_02.c 15822108　情報テクノロジー　堀田大智
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(void)
{
  ...
  /* ファイルのオープン */
  if ( (fin = fopen( "ex09_02_input.dat", "r")) == NULL )
  {
      printf("ファイルが見つかりません : ex09_02_input.dat \n");
      exit(1);
  }
  if( (fout = fopen( "ex09_02_output.dat", "w")) == NULL )
  {
    printf("ファイルが作成できません : ex09_02_output.dat \n");
    exit(1);
   }
