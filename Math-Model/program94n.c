/*
 *program94n.c 15822108 情報テクノロジー 堀田大智
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(void)
{
  ...
  /* ファイルのオープン */
  if ( (fin = fopen( "input3.txt", "r")) == NULL )
  {
    printf("ファイルが見つかりません : input3.txt \n");
    exit(1);
  }
  if( (fout = fopen( "ex13_04.txt", "w")) == NULL )
  {
    printf("ファイルが作成できません : ex12_04.txt \n");
    exit(1);
  }
