...
{
  const char* DATE = "February 3";
  const char* YEAR = "2006";
  const char* AUTHOR = "Paul Macklin";
  const char* LICENSE = "GPL v. 2";
  const char* GROUP = "the EasyBMP Project";
  const char* CONTACT = "http://easybmp.sourceforge.net";
